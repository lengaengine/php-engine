...
final class BoxCollider2D extends Component
{
    ...
    public Vector3 $size {
        ...
        set(Vector3 $value) {
            \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_size', $this->componentId, $value->x, $value->y, $value->z);
        }
    }
    ...
    public Vector3 $offset {
        ...
        set(Vector3 $value) {
            \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_offset', $this->componentId, $value->x, $value->y, $value->z);
        }
    }
    ...
    public bool $isTrigger {
        ...
        set(bool $value) {
            \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_is_trigger', $this->componentId, $value);
        }
    }
    ...
    public string $materialPath {
        ...
        set(string $value) {
            \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_material_path', $this->componentId, $value);
        }
    }
    ...
    public PhysicsMaterial2D $material {
        ...
        set(PhysicsMaterial2D $value) {
            if ($value->assetPath !== '') {
                \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_material_path', $this->componentId, $value->assetPath);
                return;
            }

            \Lenga\Engine\Core\NativeEngine::call('box_collider2d_set_material',
                $this->componentId,
                $value->friction,
                $value->bounciness,
    ...
    {
        return \Lenga\Engine\Core\NativeEngine::call('box_collider2d_is_touching',
            $this->componentId,
            $includeTriggers,
    ...
    {
        $results = \Lenga\Engine\Core\NativeEngine::call('box_collider2d_get_contacts',
            $this->componentId,
            $includeTriggers,
            $layerMask ?? Physics2D::ALL_LAYERS,
        );
    ...
    private function getState(): array
    {
         ...
         * } $state
         */
        $state = \Lenga\Engine\Core\NativeEngine::call('box_collider2d_get_state', $this->componentId);
