...
final class CapsuleCollider3D extends Component
{
    ...
    public float $radius {
        ...
        set(float $value) {
            \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_set_radius', $this->componentId, $value);
        }
    }
    ...
    public float $height {
        ...
        set(float $value) {
            \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_set_height', $this->componentId, $value);
        }
    }
    ...
    public Vector3 $offset {
        ...
        set(Vector3 $value) {
            \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_set_offset', $this->componentId, $value->x, $value->y, $value->z);
        }
    }
    ...
    public bool $isTrigger {
        ...
        set(bool $value) {
            \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_set_is_trigger', $this->componentId, $value);
        }
    }

    public function isTouching(bool $includeTriggers = true, ?int $layerMask = null): bool
    {
        return \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_is_touching',
            $this->componentId,
            $includeTriggers,
    ...
    {
        $results = \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_get_contacts',
            $this->componentId,
            $includeTriggers,
            $layerMask ?? Physics3D::ALL_LAYERS,
        );
    ...
    private function getState(): array
    {
         ...
         * } $state
         */
        $state = \Lenga\Engine\Core\NativeEngine::call('capsule_collider3d_get_state', $this->componentId);
