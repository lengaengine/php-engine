...
final class PlaneRenderer extends Component
{
    ...
    {
        \Lenga\Engine\Core\NativeEngine::call('plane_renderer_set_size', $this->componentId, $width, $length);
    }
    ...
    public string $materialPath {
        ...
        set(string $value) {
            \Lenga\Engine\Core\NativeEngine::call('plane_renderer_set_material_path', $this->componentId, $value);
        }
    }
    ...
    {
        \Lenga\Engine\Core\NativeEngine::call('plane_renderer_set_color', $this->componentId, $red, $green, $blue, $alpha);
    }
    ...
    private function getState(): array
    {
         ...
         * } $state
         */
        $state = \Lenga\Engine\Core\NativeEngine::call('plane_renderer_get_state', $this->componentId);
