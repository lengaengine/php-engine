...
final class CubeRenderer extends Component
{
    ...
    {
        \lenga_internal_cube_renderer_set_size($this->componentId, $width, $height, $length);
    }
    ...
    public string $materialPath {
        ...
        set(string $value) {
            \lenga_internal_cube_renderer_set_material_path($this->componentId, $value);
        }
    }
    ...
    {
        \lenga_internal_cube_renderer_set_color($this->componentId, $red, $green, $blue, $alpha);
    }
    ...
    private function getState(): array
    {
         ...
         * } $state
         */
        $state = \lenga_internal_cube_renderer_get_state($this->componentId);
