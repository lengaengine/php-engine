...
final class PointLight extends Component
{
    ...
    public float $intensity {
        ...
        set(float $value) {
            \Lenga\Engine\Core\NativeEngine::call('point_light_set_intensity', $this->componentId, $value);
        }
    }
    ...
    public float $range {
        ...
        set(float $value) {
            \Lenga\Engine\Core\NativeEngine::call('point_light_set_range', $this->componentId, $value);
        }
    }
    ...
    {
        \Lenga\Engine\Core\NativeEngine::call('point_light_set_color', $this->componentId, $red, $green, $blue, $alpha);
    }
    ...
    private function getState(): array
    {
         ...
         * } $state
         */
        $state = \Lenga\Engine\Core\NativeEngine::call('point_light_get_state', $this->componentId);
