...
final class Bindings
{
    ...
    public static function tweenUiTextNumberTo(
        int $elementId,
        float $value,
        float $duration,
        float $delay,
        ...
        return \lenga_internal_tween_ui_text_number_to_by_element_id(
            $elementId,
            $value,
            $duration,
            $delay,
    ...
    public static function tweenUiScalarTo(
        int $elementId,
        string $property,
        float $value,
        float $duration,
        ...
        return \lenga_internal_tween_ui_scalar_to_by_element_id(
            $elementId,
            $property,
            $value,
            $duration,
    ...
    public static function tweenUiColorTo(
        int $elementId,
        string $property,
        float $red,
        float $green,
        ...
        return \lenga_internal_tween_ui_color_to_by_element_id(
            $elementId,
            $property,
            $red,
            $green,
