...
/** --- Tween Functions --- */
if (!function_exists("lenga_internal_tween_move_to_by_transform_id")) {
    function lenga_internal_tween_move_to_by_transform_id(int $transformId, float $x, float $y, float $z, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_move_to_by_transform_id] Function not implemented. TransformId: $transformId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_move_local_to_by_transform_id")) {
    function lenga_internal_tween_move_local_to_by_transform_id(int $transformId, float $x, float $y, float $z, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_move_local_to_by_transform_id] Function not implemented. TransformId: $transformId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_scale_to_by_transform_id")) {
    function lenga_internal_tween_scale_to_by_transform_id(int $transformId, float $x, float $y, float $z, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_scale_to_by_transform_id] Function not implemented. TransformId: $transformId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_rotate_to_by_transform_id")) {
    function lenga_internal_tween_rotate_to_by_transform_id(int $transformId, float $x, float $y, float $z, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_rotate_to_by_transform_id] Function not implemented. TransformId: $transformId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_rotate_local_to_by_transform_id")) {
    function lenga_internal_tween_rotate_local_to_by_transform_id(int $transformId, float $x, float $y, float $z, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_rotate_local_to_by_transform_id] Function not implemented. TransformId: $transformId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_anchor_min_to_by_element_id")) {
    function lenga_internal_tween_ui_anchor_min_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_anchor_min_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_anchor_max_to_by_element_id")) {
    function lenga_internal_tween_ui_anchor_max_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_anchor_max_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_pivot_to_by_element_id")) {
    function lenga_internal_tween_ui_pivot_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_pivot_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_anchored_position_to_by_element_id")) {
    function lenga_internal_tween_ui_anchored_position_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_anchored_position_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_size_delta_to_by_element_id")) {
    function lenga_internal_tween_ui_size_delta_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_size_delta_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_scale_to_by_element_id")) {
    function lenga_internal_tween_ui_scale_to_by_element_id(int $elementId, float $x, float $y, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_scale_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_rotation_to_by_element_id")) {
    function lenga_internal_tween_ui_rotation_to_by_element_id(int $elementId, float $rotation, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_rotation_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_text_number_to_by_element_id")) {
    function lenga_internal_tween_ui_text_number_to_by_element_id(int $elementId, float $value, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative, int $decimals, string $prefix, string $suffix): int
    {
        Debug::error("[lenga_internal_tween_ui_text_number_to_by_element_id] Function not implemented. ElementId: $elementId");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_scalar_to_by_element_id")) {
    function lenga_internal_tween_ui_scalar_to_by_element_id(int $elementId, string $property, float $value, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_scalar_to_by_element_id] Function not implemented. ElementId: $elementId, Property: $property");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_ui_color_to_by_element_id")) {
    function lenga_internal_tween_ui_color_to_by_element_id(int $elementId, string $property, float $red, float $green, float $blue, float $alpha, float $duration, float $delay, string $easing, bool $useUnscaledTime, bool $relative): int
    {
        Debug::error("[lenga_internal_tween_ui_color_to_by_element_id] Function not implemented. ElementId: $elementId, Property: $property");
        return 0;
    }
}

if (!function_exists("lenga_internal_tween_pause")) {
    function lenga_internal_tween_pause(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_pause] Function not implemented. TweenId: $tweenId");
        return false;
    }
}

if (!function_exists("lenga_internal_tween_resume")) {
    function lenga_internal_tween_resume(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_resume] Function not implemented. TweenId: $tweenId");
        return false;
    }
}

if (!function_exists("lenga_internal_tween_cancel")) {
    function lenga_internal_tween_cancel(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_cancel] Function not implemented. TweenId: $tweenId");
        return false;
    }
}

if (!function_exists("lenga_internal_tween_is_complete")) {
    function lenga_internal_tween_is_complete(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_is_complete] Function not implemented. TweenId: $tweenId");
        return false;
    }
}

if (!function_exists("lenga_internal_tween_is_playing")) {
    function lenga_internal_tween_is_playing(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_is_playing] Function not implemented. TweenId: $tweenId");
        return false;
    }
}

if (!function_exists("lenga_internal_tween_exists")) {
    function lenga_internal_tween_exists(int $tweenId): bool
    {
        Debug::error("[lenga_internal_tween_exists] Function not implemented. TweenId: $tweenId");
        return false;
    }
}
